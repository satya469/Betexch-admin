...
export default function Subadmin() {
  return (
    <>
      ...
      <li className="nav-item">
        <NavLink to="superagent-transactions" className="nav-link">
          <i className="nav-icon fas fa-th" />
          <p>Debit/Credit Entry (S)</p>
        </NavLink>
      </li>
      <li className="nav-item">
        <NavLink to="master-transactions" className="nav-link">
          <i className="nav-icon fas fa-th" />
      ...
      <li className="nav-item">
        <NavLink to="super-ledger" className="nav-link">
          <i className="nav-icon fas fa-th" />
          <p>All Super Agent Ledger</p>
        </NavLink>
      </li>
      <li className="nav-item">
        <NavLink to="master-ledger" className="nav-link">
          <i className="nav-icon fas fa-th" />
      ...
      <li className="nav-item">
        <NavLink to="master-report" className="nav-link">
          <i className="nav-icon fas fa-th" />
          <p>Master Reports</p>
        </NavLink>
      </li>
      <li className="nav-item">
        <NavLink to="super-report" className="nav-link">
          <i className="nav-icon fas fa-th" />
          <p>Super Reports</p>
        </NavLink>
      </li>
      ...
      <li className="nav-item">
        <NavLink to="master-login-report" className="nav-link">
          <i className="nav-icon fas fa-th" />
          <p>Master Login Reports</p>
        </NavLink>
      </li>
      <li className="nav-item">
        <NavLink to="super-login-report" className="nav-link">
          <i className="nav-icon fas fa-th" />
