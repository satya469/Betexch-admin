...
export default function AgentLoginReport(props) {
  ...
  const myledger = async () => {
   const formdata = {uid : "C19"}
    axios.post(`/subadmin/agent-login-report?page=1&limit=10`, formdata, options)
      .then(res => {
...
{/* 
                      <tr>
                        ...
                        <td>SUB10</td>
                        <td>SUB 80</td>
                        <td>2401:4900:1f3d:de17:2444:2eb0:62c9:dbc</td>
                        <td>13-07-2022 14:39:11</td>
                        <td>13-07-2022 14:39:11</td>
                      </tr>
                      <tr>
                        <td>2</td>
